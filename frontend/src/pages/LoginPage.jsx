...
import { BotMessageSquare, Mail, Lock, Eye, EyeOff, Loader2} from "lucide-react";
import { Link } from "react-router-dom";
import AuthImagePattern2 from "../components/AuthImagePattern2.jsx";
...
export const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      <AuthImagePattern2
        title="Welcome back!!"
        subtitle="Sign in to continue and catch up with your messages."
      />
